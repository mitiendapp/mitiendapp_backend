...
class CompanyRepository {
    ...
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const company = yield models_1.default.Company.findByPk(id);
                return company;
            }
            catch (error) {
    ...
    update(document, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const alreadyExist = yield this.findOne(document);
            if (alreadyExist == null) {
                throw new Error('Client not found');
            }
            try {
                const newCompany = yield models_1.default.Company.update(payload, { where: { document } });
                return newCompany;
            }
            catch (error) {
    ...
    delete(document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const companyDeleted = yield models_1.default.Company.destroy({ where: { document } });
