...
ROUTER.get('/product/:companyId', product_controller_1.getProductByCompanyId);
ROUTER.post('/product/create', upload.single('image'), product_controller_1.createProduct);
ROUTER.post('/product/create/:companyId', upload.single('image'), product_controller_1.createProduct);
